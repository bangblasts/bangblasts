...
export interface BangBlastsCoinInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "PRICE"
      | "approve"
...
export namespace MintNftEvent {
  export type InputTuple = [senderAddress: AddressLike, nftToken: BigNumberish];
  export type OutputTuple = [senderAddress: string, nftToken: bigint];
  export interface OutputObject {
...
export interface BangBlastsCoin extends BaseContract {
  connect(runner?: ContractRunner | null): BangBlastsCoin;
  waitForDeployment(): Promise<this>;

  interface: BangBlastsCoinInterface;
  ...
  mintNFT: TypedContractMethod<[_tokenId: BigNumberish], [void], "payable">;
  ...
  reserveNFT: TypedContractMethod<
  ...
  getEvent(
    ...
    MintNftEvent.InputTuple,
    MintNftEvent.OutputTuple,
    MintNftEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    ...
    "MintNft(address,uint256)": TypedContractEvent<
      MintNftEvent.InputTuple,
      MintNftEvent.OutputTuple,
      MintNftEvent.OutputObject
    >;
    MintNft: TypedContractEvent<
      MintNftEvent.InputTuple,
      MintNftEvent.OutputTuple,
      MintNftEvent.OutputObject
    >;
