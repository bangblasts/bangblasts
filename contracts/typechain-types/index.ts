...
export type { BangBlastsCoin } from "./contracts/BangBlasts.sol/BangBlastsCoin";
export { BangBlastsCoin__factory } from "./factories/contracts/BangBlasts.sol/BangBlastsCoin__factory";
